...
export const getRouterData = app => {
  const routerConfig = {
    ...
    '/permission/editPermission': {
      component: dynamicWrapper(app, ['permission'], () => import('../routes/Permission/EditPermission')),
    },
    '/permission/createPermission': {
      component: dynamicWrapper(app, ['permission'], () => import('../routes/Permission/CreatePermission')),
    },
